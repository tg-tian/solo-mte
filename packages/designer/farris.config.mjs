...
export default {
    ...
    externals: {
        include: ['jsonp', 'echarts', 'lodash-es', 'lodash', 'axios', '@farris/ui-vue', '@farris/mobile-ui-vue','@gsp-wf/wf-bizprocess-lookup-vue', 'vue','rxjs','rxjs/operators'],
        filter: (externals) => {
            return (id) => {
    ...
    alias: [
        ...
        { find: '@farris/mobile-ui-vue', replacement: fileURLToPath(new URL('../mobile-ui-vue/components', import.meta.url)) },
