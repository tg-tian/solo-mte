...
import FANavigation from '@farris/farris-admin/components/navigation/navigation.component';
import FANavigationCompact from '@farris/farris-admin/components/navigation/navigation-compact.component';
import FAContentArea from '@farris/farris-admin/components/content-area/content-area.component';
import { ConfigOptions, WorkAreaInstance } from '@farris/farris-admin/composition/types';
import { useConfig } from '@farris/farris-admin/composition/use-config';
import { useFunctionInstance } from '@farris/farris-admin/composition/use-function-instance';
import { useMenuData } from '@farris/farris-admin/composition/use-menu-data';
import { useWorkAreaInstance } from '@farris/farris-admin/composition/use-work-area-instance';
