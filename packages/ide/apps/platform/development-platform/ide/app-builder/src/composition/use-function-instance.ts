...
export function useFunctionInstance(config: UseConfig): UseFunctionInstance {
    ...
    const designerMap = new Map<string, string>([
        ...
        ['MobileForm', '/platform/dev/main/web/webide/plugins-new/mobile-farris-designer/index.html'],
        ['HelpMetadata', '/platform/dev/main/web/webide/plugins/help-designer/index.html'],
        ['QueryObject', '/platform/dev/main/web/webide/plugins-new/qo-designer/index.html'],
        ['InternalApi', '/platform/dev/main/web/webide/plugins/iapi-package/index.html'],
        ['Event', '/platform/dev/main/web/webide/plugins/event-designer/index.html'],
        ['WebComponent', '/platform/dev/main/web/webide/plugins-new/controller-cmp-designer/index.html'],
        ['WebCommand', '/platform/dev/main/web/webide/plugins-new/controller-cmp-designer/index.html'],
        ['WebServiceComponent', '/platform/dev/main/web/webide/plugins/webservicecmp-designer/index.html'],
        ['BEComponent', '/platform/dev/main/web/webide/plugins/cmp-designer/index.html'],
        ['BEMgrComponent', '/platform/dev/main/web/webide/plugins/cmp-designer/index.html'],
        ['DeterminationComponent', '/platform/dev/main/web/webide/plugins/cmp-designer/index.html'],
        ['ValidationComponent', '/platform/dev/main/web/webide/plugins/cmp-designer/index.html'],
        ['UDTValidComponent', '/platform/dev/main/web/webide/plugins/cmp-designer/index.html'],
        ['UDTDtmComponent', '/platform/dev/main/web/webide/plugins/cmp-designer/index.html'],
        ['VMComponent', '/platform/dev/main/web/webide/plugins/cmp-designer/index.html'],
        ['CommonComponent', '/platform/dev/main/web/webide/plugins-new/ccmp-package/index.html'],
        ['SourceCodeMetadata', '/platform/dev/main/web/webide/plugins/webcode-designer/index.html'],
        ['UnifiedDataType', '/platform/dev/main/web/webide/plugins/udt-designer/index.html'],
        ['CommonDataType', '/platform/dev/main/web/webide/plugins/cdt-package/index.html'],
        ['QdpProcessUnitCmp', '/platform/dev/main/web/webide/plugins/query-cmp-designer/index.html'],
        ['QdpConditionCmp', '/platform/dev/main/web/webide/plugins/query-cmp-designer/index.html'],
        ['QdpDeterminationCmp', '/platform/dev/main/web/webide/plugins/query-cmp-designer/index.html'],
        ['QdpValidationCmp', '/platform/dev/main/web/webide/plugins/query-cmp-designer/index.html'],
        ['DataImport', '/platform/dev/main/web/webide/plugins/data-import/index.html'],
        ['DataExport', '/platform/dev/main/web/webide/plugins/data-export/index.html'],
        ['CodeRule', '/platform/dev/main/web/webide/plugins/coderule-designer/index.html'],
        ['MobilePageFlowMetadata', '/platform/dev/main/web/webide/plugins/mobile-page-flow-designer/index.html'],
        ['DataTransferObject', '/platform/dev/main/web/webide/plugins/dto-package/index.html']
    ])
